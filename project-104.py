...
def calculateMode():
    ...
    for height, occurence in data.items():
        if 75<float(height)<85:
            ...
            mode_data_range["195-125"]+=occurence
        elif 125<float(height)<135:
            mode_data_range["195-135"]+=occurence
        elif 135<float(height)<145:
            mode_data_range["195-145"]+=occurence
        elif 145<float(height)<155:
            mode_data_range["195-155"]+=occurence
        elif 155<float(height)<165:
            mode_data_range["195-165"]+=occurence
        elif 165<float(height)<175:
            mode_data_range["195-175"]+=occurence
